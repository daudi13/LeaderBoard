...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"fetchScore\": () => (/* binding */ fetchScore)\n/* harmony export */ });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nvar fetchScore = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, id, score) {\n    var res, data, data2;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return fetch([url, id, score].join(''));\n\n          case 2:\n            res = _context.sent;\n            _context.next = 5;\n            return res.json();\n\n          case 5:\n            data = _context.sent;\n            _context.next = 8;\n            return data;\n\n          case 8:\n            data2 = _context.sent;\n            console.log(data2);\n\n          case 10:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function fetchScore(_x, _x2, _x3) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\n//# sourceURL=webpack://webpack-template/./src/modules/fetchScore.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"createGame\": () => (/* binding */ createGame),\n/* harmony export */   \"addScore\": () => (/* binding */ addScore)\n/* harmony export */ });\nvar createGame = function createGame(base, endpoint, bodyObject) {\n  fetch([base, endpoint].join(''), {\n    method: 'POST',\n    body: JSON.stringify(bodyObject),\n    headers: {\n      'Content-type': 'application/json; charset=UTF-8'\n    }\n  }).then(function (response) {\n    return response.json();\n  }).then(function (msg) {\n    return console.log(msg);\n  })[\"catch\"](function (err) {\n    return alert(err);\n  });\n};\nvar addScore = function addScore(url, id, score, bodyObject) {\n  fetch([url, id, score].join(''), {\n    method: 'POST',\n    body: JSON.stringify(bodyObject),\n    headers: {\n      'Content-type': 'application/json; charset=UTF-8'\n    }\n  }).then(function (response) {\n    return response.json();\n  }).then(function (msg) {\n    return console.log(msg);\n  })[\"catch\"](function (err) {\n    return alert(err);\n  });\n};\n\n//# sourceURL=webpack://webpack-template/./src/modules/formdata.js?");
